...
export default function UI({ 
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-10 font-sans">
      ...
      {!freeReading && (
        <div className="absolute bottom-4 left-4 right-4 md:hidden pointer-events-auto flex flex-col items-center bg-white/90 backdrop-blur-md border border-gray-200/50 shadow-2xl rounded-3xl px-5 py-3 select-none text-center">
      ...
      {freeReading && (
        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-white/90 backdrop-blur-md border border-gray-200/50 shadow-xl px-6 py-2.5 rounded-full flex items-center gap-4 pointer-events-auto select-none max-w-[90vw] overflow-x-auto scrollbar-none">
